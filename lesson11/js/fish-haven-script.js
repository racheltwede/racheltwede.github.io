...
const weatherURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=99adfa7e0c76ea8d2eb5fdc33937bd76";
fetch(weatherURL)
...
//gets forecast
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=99adfa7e0c76ea8d2eb5fdc33937bd76";
fetch(forecastURL)
  .then((response) => response.json())
  .then((jsObject) => {
