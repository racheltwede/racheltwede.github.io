...
fetch(requestURL)
    ...
    .then(function (jsonObject) {
        ...
        const weatherTowns = towns.filter(town => town.name == "Soda Springs" || town.name == "Fish Haven" || town.name == "Preston");
        ...
        for (let i = 0; i < weatherTowns.length; i++) {
            ...
            populationP.textContent = "Population: " + weatherTowns[i].currentPopulation;
            rainP.textContent = "Yearly rainfall: " + weatherTowns[i].averageRainfall + " in";
